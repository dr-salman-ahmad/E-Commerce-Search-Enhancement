...
class VectorDBHandler:
    def __init__(self,image_collection_name,text_collection_name):
...
class FeatureExtractor:
    def __init__(self,image_model_name,text_model_name):
        try:
            self.text_model = AutoModel.from_pretrained(text_model_name, trust_remote_code=True) # trust_remote_code is needed to use the encode method
